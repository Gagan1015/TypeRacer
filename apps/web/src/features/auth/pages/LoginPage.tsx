    ...
    <div className="relative flex min-h-screen items-center justify-center px-4 py-12">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="mb-10 text-center">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-[#d1d0c5]">welcome back</h1>
          <p className="mt-2 text-sm text-[#646669]">sign in to continue racing</p>
        </div>
        ...
        <div className="rounded-2xl border border-[#3b3f47]/60 bg-[#2c2e33]/50 p-8 shadow-[0_20px_60px_rgba(0,0,0,0.4)] backdrop-blur-xl">
          ...
          <div className="my-6 flex items-center gap-3">
            ...
            <span className="text-xs text-[#646669]">or sign in with email</span>
            <div className="h-px flex-1 bg-gradient-to-r from-transparent via-[#3b3f47] to-transparent" />
          </div>
